...
{
	public partial class NavigationViewHandler : ViewHandler<IStackNavigationView, NSView>, IPlatformViewHandler
	{
		ControlsNavigationController? _controlsNavigationController;
		NSViewController? IPlatformViewHandler.ViewController => _controlsNavigationController;
