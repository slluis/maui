...
{
	public partial class RadioButtonHandler : ViewHandler<IRadioButton, Microsoft.Maui.Platform.ContentView>
	{
		protected override Microsoft.Maui.Platform.ContentView CreatePlatformView() => throw new NotImplementedException();
