...
{
	public partial class SwipeViewHandler : ViewHandler<ISwipeView, AppKit.NSView>
	{
		protected override AppKit.NSView CreatePlatformView() => throw new NotImplementedException();
