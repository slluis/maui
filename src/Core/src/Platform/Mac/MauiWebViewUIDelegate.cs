...
namespace Microsoft.Maui.Platform
{
	public class MauiWebViewUIDelegate : WKUIDelegate
	{
		...
		static readonly string LocalOK = NSBundle.FromIdentifier("com.apple.AppKit").GetLocalizedString("OK");
		static readonly string LocalCancel = NSBundle.FromIdentifier("com.apple.AppKit").GetLocalizedString("Cancel");
