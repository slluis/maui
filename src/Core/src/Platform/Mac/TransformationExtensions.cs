...
namespace Microsoft.Maui.Platform
{
	...
	{
		public static void UpdateTransformation(this NSView nativeView, IView? view)
		{
		...
		public static void UpdateTransformation(this NSView nativeView, IView? view, CALayer? layer, CGPoint? originalAnchor)
		{
			if (view == null)
				return;
