...
namespace Microsoft.Maui.Platform
{
	public static class TextViewExtensions
	{
		...
		{
			// TODO COCOA
/*			var textAttr = textView.AttributedString?.WithCharacterSpacing(textStyle.CharacterSpacing);
			if (textAttr != null)
				textView.AttributedText = textAttr;

			if (textView is MaNSTextView maNSTextView)
			{
				var phAttr = maNSTextView.AttributedPlaceholderText?.WithCharacterSpacing(textStyle.CharacterSpacing);
				if (phAttr != null)
					maNSTextView.AttributedPlaceholderText = phAttr;
			}
*/
		}
...
/*			if (editor.IsTextPredictionEnabled)
		...
		{
			textView.Editable = !editor.IsReadOnly && !editor.InputTransparent;
		}
		...
		public static void UpdateCursorPosition(this NSTextView textView, IEditor editor)
		{
			// TODO COCOA
		...
		public static void UpdateSelectionLength(this NSTextView textView, IEditor editor)
		{
			// TODO COCOA
			//var selectedTextRange = textView.SelectedTextRange;
			//if (selectedTextRange == null)
		...
		public static void UpdateHorizontalTextAlignment(this NSTextView textView, IEditor editor)
		{
			// TODO COCOA
		...
		static void UpdateCursorSelection(this NSTextView textView, IEditor editor)
		{
			// TODO COCOA
			//if (!editor.IsReadOnly)
			//{
			//	NSTextPosition start = GetSelectionStart(textView, editor, out int startOffset);
		...
		//static UITextPosition GetSelectionStart(NSTextView textView, IEditor editor, out int startOffset)
		//{
		...
		//static UITextPosition GetSelectionEnd(NSTextView textView, IEditor editor, UITextPosition start, int startOffset)
		//{
