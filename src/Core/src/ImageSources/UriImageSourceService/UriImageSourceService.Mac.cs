...
namespace Microsoft.Maui
{
	public partial class UriImageSourceService
	{
		...
		public async Task<IImageSourceServiceResult<NSImage>?> GetImageAsync(IUriImageSource imageSource, float scale = 1, CancellationToken cancellationToken = default)
		{
