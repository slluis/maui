...
namespace Microsoft.Maui
{
	public partial class StreamImageSourceService
	{
		...
		public async Task<IImageSourceServiceResult<NSImage>?> GetImageAsync(IStreamImageSource imageSource, float scale = 1, CancellationToken cancellationToken = default)
		{
