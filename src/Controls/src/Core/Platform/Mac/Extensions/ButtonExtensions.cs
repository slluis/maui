...
namespace Microsoft.Maui.Controls.Platform
{
	...
	{
/*		static CGRect GetTitleBoundingRect(this NSButton platformButton)
		{
		...
		public static void UpdatePadding(this NSButton platformButton, Button button)
		{
/*			double spacingVertical = 0;
			...
			if (button.ImageSource != null)
			{
				...
				{
					var imageHeight = platformButton.Image?.Size.Height ?? 0f;
		...
		public static void UpdateContentLayout(this NSButton platformButton, Button button)
		{
			/*
			...
			// bounds of the NSButton. We could set the NSButton to clip bounds
...
#pragma warning restore CA1416
		...
		public static void UpdateText(this NSButton platformButton, Button button)
		{
			var text = TextTransformUtilites.GetTransformedText(button.Text, button.TextTransform);
			platformButton.StringValue = text;
		...
		public static void UpdateLineBreakMode(this NSButton nativeButton, Button button)
		{
			nativeButton.LineBreakMode = button.LineBreakMode switch
			{
				LineBreakMode.NoWrap => NSLineBreakMode.Clipping,
				LineBreakMode.WordWrap => NSLineBreakMode.ByWordWrapping,
